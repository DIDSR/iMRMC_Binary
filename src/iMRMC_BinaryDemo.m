...
[S1,S2] = iMRMC_BinarySimulate(r,PC,Nr,Nc);
ret = iMRMC_BinaryAnalyze_OR(S1,S2);
disp('the estimated 95% confidence interval for PC(2)-PC(1) is:');
ret.CI95

anaMethod = 'iMRMC_BinaryAnalyze_OR';
...
disp('..........................');
prob = iMRMC_BinaryValidate(anaMethod,Nr, Nc, r, PC, nexp);
...
disp('it may take a couple of minutes... (set smaller number of MC trials for a speedy demo)')
disp('..........................');
pow = iMRMC_BinaryPower('iMRMC_BinaryAnalyze_OR',Nr, Nc, r, PC, nim, nexp);
